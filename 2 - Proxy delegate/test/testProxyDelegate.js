...
contract("ProxyDelegate", accounts => {
    ...
    it("getMsgSender by delegatecall should result in LogResult event with sender account address", () => {
    ...
    it("setVersion by delegatecall should update version in the ProxyDelegate contract", async () => {
        ...
        /*
        The value of owner has been changed since the SomeLibrary.setVersion
        was invoked with delegatecall. Inside this function we update the value of the 
        first field (first storage slot) in the contract. Since it's delegatecall
        we actually update the value of the owner variable of the ProxyDelegate.
        */
